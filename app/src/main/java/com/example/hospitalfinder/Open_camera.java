...
public class Open_camera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(Open_camera.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ActivityCompat.requestPermissions(Open_camera.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
        ...
        btnOpen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Uri imageuri = FileProvider.getUriForFile(Open_camera.this, "com.example.hospitalfinder.fileprovider", image);
    ...
    private void imagesavetomyphonegallery() {
        ...
        if (imageView.getDrawable() == null) {
            ...
            File dir = new File(file.getAbsolutePath() + "/Hospital Finder");
            dir.mkdir();
